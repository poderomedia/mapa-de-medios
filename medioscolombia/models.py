...
class Propietario(models.Model):
	...
	pcentsociedadn = models.CharField("Porcentaje", max_length=255, null=True, blank=True)
	fechainfo = models.DateField("Fecha Información", null=True, blank=True)
	fuentesociedad = models.ForeignKey(Fuente, verbose_name="Fuente", related_name="fuente2sociedad", null=True, blank=True, max_length=255)
...
class Grupo(models.Model):
	...
	paisorigen = models.ForeignKey(PaisSociedad, related_name="pais_grupo", verbose_name="País de Origen", blank=True)
