...
TableTools.BUTTONS = {
	"csv": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "CSV",
		"sToolTip": "Exportar a CSV para Base de Datos",
		"sFieldBoundary": '"',
		"sFieldSeperator": ",",
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "Excel",
		"sToolTip": "Exportar a CSV para Excel",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Previsualización</h6><p>Use Imprimir en su navegador para "+
		  "imprimir esta tabla. Cerrar con Esc.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Ver impresión",
